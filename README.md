...
In version 1.2 there is a graphical mode that allow to manipulate pixels as well. Actually it uses 256 RAM Tiles that can be positioned any place in the screen and by this way it is possible to set individual pixels.
...
This graphical mode allow to create some animation such as in the Space_Invaders_Animation_Demo sketch found in exmamples.

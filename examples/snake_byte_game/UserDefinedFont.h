...
const uint8_t GRAPH_ASCII_FONT[128*8] = {

// There are 32 inital characters that we can use for anything and create our own bitmaps! The last 128 characters are also free for any use...
// If necessary, all the 256 characters (codes 0..255) can be redefined for your own purpose...

// Here we define 8 tiles from 0 to 7 for runnig SnakeByte game example, but you can modify it the way you want!
  // Mushroom Tile Bitmap                 U+0000 (user defined)
  0B00111000,
  0B01111100,
  0B01111100,
  0B11111110,
  ...
  // Fly Tile Bitmap                      U+0001 (user defined)
  0B01101100,
  0B00010000,
  0B01111100,
  0B10111010,
  ...
  // Beetle Tile Bitmap                   U+0002 (user defined)
  0B10000010,
  0B01010100,
  0B00111000,
  0B11111110,
  ...
  // Snake Head UP Tile Bitmap            U+0003 (user defined)
  0B00100100,
  0B00011000,
  0B00111100,
  0B01111110,
  ...
  // Snake Head DOWN Tile Bitmap          U+0004 (user defined)
  0B00011000,
  0B01111110,
  0B11111111,
  0B10011001,
  ...
  // Snake Head LEFT Tile Bitmap          U+0005 (user defined)
  0B00001100,
  0B00010110,
  0B10110110,
  0B01111111,
  ...
  // Snake Head RIGHT Tile Bitmap         U+0006 (user defined)
  0B00110000,
  0B01101000,
  0B01101101,
  0B11111110,
  ...
  // Snake Body Tile Bitmap               U+0007 (user defined)
  0B00111100,
  0B01111110,
  0B11100111,
  0B11011011,
